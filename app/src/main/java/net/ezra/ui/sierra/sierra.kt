...
@Composable
fun SierraScreen(navController:NavHostController){
    ...
    Scaffold(
        ...
        content ={
            ...
            LazyColumn(
                ...
                item { Card {
                    Text(text = "Located along Ngong Road, Sierra Bar and Grill is a charming destination for a dinner date." +
                            "The amber lighting and wooden floors go well  with the mouth watering Steaks that they offer." +
                            "This destination is just giving warmth and hope. Ideal for the first date." )
