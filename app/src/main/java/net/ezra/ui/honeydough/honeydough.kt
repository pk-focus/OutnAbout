package net.ezra.ui.honeydough
...
@Composable
fun HoneydoughScreen(navController:NavHostController){
    ...
    Scaffold(
        ...
        content ={
            ...
            LazyColumn(
                ...
                item { Card {
                    Text(text = " Healthy can be classy. This is clearly portrayed by this beauty. Honey and Dough is The haven for our Vegetarian Baddies." +
                            "Topped off with the beautiful Greenery, the serenity of the area brings as much peace to the mind as the food nourishes the body." )
